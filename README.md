...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dev-api.stackbit.com/pull/607ff70f6512b800176333ff
...
To start editing your site, you can use the Sanity interface at https://polite-bee-ff70f.sanity.studio/.
...
Generated at `2021-04-21T09:59:30.102Z` by Stackbit version `0.3.51-develop.0`.